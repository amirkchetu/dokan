        ...
        <table class="form-table">
            <tbody>
            	<tr>
                    ...
                    <td>
                      <select name="dokan_store_status" class="">
                        <option value="ns"<?php echo esc_attr( $store_settings['store_status']=="ns" ? 'selected=selected':'' ); ?>>New Member</option>
                        <option value="vs"<?php echo esc_attr( $store_settings['store_status']=="vs" ? 'selected=selected':'' ); ?>>Verified Member</option>
                        <option value="ts"<?php echo esc_attr( $store_settings['store_status']=="ts" ? 'selected=selected':'' ); ?>>Trusted Member</option>
                        <option value="ss"<?php echo esc_attr( $store_settings['store_status']=="ss" ? 'selected=selected':'' ); ?>>Star Member</option>
                        <option value="gs"<?php echo esc_attr( $store_settings['store_status']=="gs" ? 'selected=selected':'' ); ?>>Gold Member</option>
                        <option value="ps"<?php echo esc_attr( $store_settings['store_status']=="ps" ? 'selected=selected':'' ); ?>>Platinum Member</option>
                      </select>                      
                    </td>
                </tr>
                <tr>
