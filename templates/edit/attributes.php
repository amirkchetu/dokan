            ...
            <div class="inputs-box woocommerce_attribute" data-count="<?php echo $i; ?>">
                <div class="box-header">
                    ...
                    <?php } else { ?>
                        ...
                        <select class="category-name" name="attribute_names[<?php echo $i; ?>]">
                          <?php foreach($attribute_taxonomies as $att) { ?>
                           <option value="<?php echo $att->attribute_label; ?>" <?php echo($att->attribute_label == $attribute_name ) ? 'selected' : ''; ?>>
