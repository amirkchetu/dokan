<style>
.wpo-header, .topbar, body > .col-md-12, footer, .wpo-copyright {
...
$_shipping_type	 = get_post_meta( $post_id, '_shipping_type', true );
                        ...
                        <div id="tab-container" class='tab-container'> <!-- Only required for left/right tabs -->
                            ...
                            <ul class="dokan_tabs">
                                ...
                                $dokan_product_data_tabs = apply_filters( 'dokan_product_data_tabs', array(
									...
									'sellin' => array(
                                        'label'  => __( 'Delivery Location', 'dokan' ),
                                        'target' => 'product-sellin',
                                        'class'  => array(),
                                    ),
                                    'shipping' => array(
                            ...
                            <div id="tabs_container">
                                ...
                                <div id="product-sellin">
                                    ...
                                    <?php include_once dirname(__FILE__) . '/edit/sellin.php'; ?>
